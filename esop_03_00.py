# This program is for converting the various system of the main system into and object and do various operatoins and also link with a database file for storing the data of many instances of the object
...
class System:
    ...
    system_code = 'UAS'  # input("Enter the system name: ")
    system_name = 'TAPAS'
    ...
    def create_database(self, filepath = None, filename = None, system_id = None, system_code = None, system_name = None):
        ...
        if no_table:
            ...
            print("The Top Level System is : {} ".format(top_system))
        else:
    ...
    def ui_menu(self):
        ...
        menu_items = ['0: Exit the program!!','1: Create main systems','2: Create child systems','3: View child systems', "4: View a system's hierarchy", "5: Delete Record "]
        while True:
            for k in menu_items:
                print(k)
