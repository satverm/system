...
class System:
    ...
    system_name = 'af-8'  # input("Enter the system name: ")
    filename = 'sysdata.db'  # input("Enter the database filename (anyfile.db):")
